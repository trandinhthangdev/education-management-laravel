<?php $__env->startSection('title', 'Teacher Information'); ?>
...
<section class="mt-2">
	...
	<div class="container bg-dark">
    	<div class="teacher-card m-3 text-dark text-light">
    		<div class="row">
    			<div class="col-12">
    				<button class="btn btn-success m-2 float-right" data-toggle="modal" data-target="#update-info" data-id="<?php echo e($teacher->id); ?>" id="update-info-btn"><span><i class="fa fa-edit"></i></span> Update Info</button>	
    			</div>
    		</div>
			<div class="card bg-dark">
			    <img class="card-img-top w-25 h-50 m-3 img-thumbnail" src="uploads/images/teachers/<?php echo e($teacher->image); ?>">
			    <div class="dropdown-divider"></div>
			    <div class="card-body text-light">
			        <h4 class="font-weight-bolder">Name : <span class="font-weight-normal font-italic"><?php echo e($teacher->name); ?></span></h4>
					...
					<h4 class="font-weight-bolder">Teacher Code  : <span class="font-weight-normal font-italic"><?php echo e($teacher->teacher_code); ?></span></h4>
					<h4 class="font-weight-bolder">Sex : 
						<span class="font-weight-normal font-italic">
						<?php echo e(($teacher->sex) ? 'Male' : ''); ?>

						<?php echo e(($teacher->sex == '0') ? 'Female' : ''); ?>					
						</span>
					</h4>
					<h4 class="font-weight-bolder">District : <span class="font-weight-normal font-italic"><?php echo e($teacher->district); ?></span></h4>
					<h4 class="font-weight-bolder">Province : <span class="font-weight-normal font-italic"><?php echo e($teacher->province); ?></span></h4>
					<h4 class="font-weight-bolder">Country : <span class="font-weight-normal font-italic"><?php echo e($teacher->country); ?></span></h4>
			    </div>
			</div>
		</div>
	</div>
