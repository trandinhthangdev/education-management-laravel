			        ...
			        <tr>
			            ...
			            <td><?php echo e($value->name); ?></td>
			           	...
			           	<td class="text-center">
			           		<button type="button" class="badge badge-success" data-toggle="modal" data-target="#edit-module-modal" data-id="<?php echo e($value->id); ?>" id="edit-module-btn"><span><i class="fa fa-edit"></i></span></button>
