...
<body class="bg-dark h-100">
	<div class="container mt-5">
		<div class="row">
			<div class="col-md-6 text-center mt-5 border rounded-circle p-5">
				<div class="row mb-5">
					<div class="col-12">
						<img src="{{ asset('uploads/images/pages/logo.png') }}" alt="" class="w-75">				
					</div>
				</div>
			...
			<div class="col-md-6 text-light font-weight-bolder mt-5">
				...
				<form action="{{ route('post-login') }}" method="POST">
				    ...
				    <p class="font-italic font-weight-normal mt-3">Do not have an account? <a href="{{route('register')}}"><button type="button" class="badge badge-light">REGISTER</button></a></p>
				</form>
			</div>
		</div>
	</div>
    ...
    <script type="text/javascript">
    	@if (session('response'))
		    toastr.error('{{session('response')}}', 'Response')
		@endif
    </script>
</body>
</html>