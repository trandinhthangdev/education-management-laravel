...
<section class="mt-2">
	...
	<div class="container bg-dark">
    	<div class="student-card m-3 text-dark text-light">
    		<div class="row">
    			<div class="col-12">
    				<button class="btn btn-success m-2 float-right" data-toggle="modal" data-target="#update-info" data-id="{{ $student->id }}" id="update-info-btn"><span><i class="fa fa-edit"></i></span> Update Info</button>	
    			</div>
    		</div>
			<div class="card bg-dark">
			    <img class="card-img-top w-25 h-50 m-3 img-thumbnail" src="uploads/images/students/{{ $student->image }}">
			    <div class="dropdown-divider"></div>
			    <div class="card-body text-light">
			        <h4 class="font-weight-bolder">Name : <span class="font-weight-normal font-italic">{{ $student->name }}</span></h4>
					...
					<h4 class="font-weight-bolder">Student Code  : <span class="font-weight-normal font-italic">{{ $student->student_code }}</span></h4>
					<h4 class="font-weight-bolder">Sex : 
						<span class="font-weight-normal font-italic">
							{{ ($student->sex) ? 'Male' : '' }}
							{{ ($student->sex == '0') ? 'Female' : '' }}
						</span>
					</h4>
					<h4 class="font-weight-bolder">District : <span class="font-weight-normal font-italic">{{ $student->district }}</span></h4>
					<h4 class="font-weight-bolder">Province : <span class="font-weight-normal font-italic">{{ $student->province }}</span></h4>
					<h4 class="font-weight-bolder">Country : <span class="font-weight-normal font-italic">{{ $student->country }}</span></h4>
			    </div>
			</div>
		</div>
	</div>
