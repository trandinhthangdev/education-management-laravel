		...
		<div class="row">
			...
			<div class="col-md-6 text-light font-weight-bolder mt-5">
				...
				<form action="{{ route('post-register') }}" method="POST" enctype="multipart/form-data">
				    ...
				    <p class="font-italic font-weight-normal mt-3">Do you already have an account? <a href="{{ route('login') }}"><button type="button" class="badge badge-light">LOGIN</button></a></p>
				</form>
			</div>
		</div>
	</div>
